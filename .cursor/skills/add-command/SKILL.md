---
name: add-command
description: Creates a new chat command (/something) in the open-mt2 game server — Command, Validator, Handler, registration in Commands.ts, and README update. Use whenever the user adds, changes, or implements a GM or player chat command, slash command, CommandHandler, CommandValidator, or mentions Commands.ts, CommandManager, or /help.
---
