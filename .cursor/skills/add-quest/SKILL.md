---
name: add-quest
description: Creates a new quest in open-mt2 using the @Quest/@Task decorators and the AbstractQuest API. Use whenever the user adds, changes, or implements a game quest, quest task, quest state machine, HuntQuest-style flow, or mentions QuestManager, QuestEventEnum, quest auto-discovery, or docs/quests.md.
---
